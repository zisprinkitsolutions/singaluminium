...
Route::get("sale-transection", "HomeController@sale_export");
...
Route::group(['middleware' => 'auth'], function(){
  ...
  // Work by Tarek Start
    ...
    Route::get('salse-return', 'backend\TaxInvoiceController@salsereturn')->name('salse-return');
    ...
    Route::get('tax-invoice-data', 'backend\TaxInvoiceController@searchInvoice_data')->name('searchInvoice-data');
...
Route::get('tarek-invo-update/{invoice}', 'backend\TaxInvoiceController@tarekInvUpdate')->name('tarekInvUpdate');
    ...
    //End Journal Entry
      ...
      //Sales Return
      Route::post('sales_item_temp', 'backend\SalesReturnController@sales_item_temp')->name('sales_item_temp');
      Route::post('sales_item_temp_delete', 'backend\SalesReturnController@sales_item_temp_delete')->name('sales_item_temp_delete');
      Route::get('salesReturn-list', 'backend\SalesReturnController@salesReturn_lis')->name('salesReturn-lis');

      Route::get('ReturnPrint/{id}', 'backend\PurchaseReturnController@ReturnPrint')->name('ReturnPrint');
  ...
  // work start by mominul
    ...
    Route::get('itemlist-search', 'backend\ItemListController@search')->name('itemlist-search');
    ...
    Route::post("get-item-info", "backend\PurchaseRequisitionController@get_item_info")->name("get-item-info");



    Route::post("purchadse_info_get", "backend\PurchaseReturnController@purchadse_info_get")->name("purchadse_info_get");
    ...
    // purchase returm
    Route::post('preturn_item_temp', 'backend\PurchaseReturnController@preturn_item_temp')->name('preturn_item_temp');
    Route::post('preturn_item_temp_delete', 'backend\PurchaseReturnController@preturn_item_temp_delete')->name('preturn_item_temp_delete');
  ...
  Route::post('purchase-summery/date', 'backend\PurchaseSummaryController@searchDailyPurch')->name('searchDailyPurch');
  Route::post('purchase-summery/date-range', 'backend\PurchaseSummaryController@searchDailyPurchageRange')->name('searchDailyPurchageRange');
