                                    ...
                                    <div class="col-2">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-center">
                                                @php
                                                    $employeeImage = $employee_info->employee_image ?? null;
                                                    $imagePath = $employeeImage ? asset('storage/upload/employee/'.$employeeImage) : asset('icon/avatar.png');
                                                @endphp

                                                <a href="{{ $imagePath }}" target="_blank" style="color: #000;">
                                                    <img src="{{ $imagePath }}"
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <!-- Column Titles (Left) -->
                                                    <div class="col-12">
                                                        <label for="mode" style="font-weight:900">First Name : <span style="text-right"> {{ $employee_info->first_name }}</span></label>
                                                        <label for="mode" style="font-weight:900">DOB :{{ date('d/m/Y', strtotime($employee_info->dob)) }}</label>
                                                        <label for="mode" style="font-weight:900">Gender : {{ $employee_info->gender == 'Male' ? 'Male' : 'Female' }}</label>
                                                        <label for="mode" style="font-weight:900">Blood Group : {{ $employee_info->blood_group }}</label>
                                                        {{-- <label for="mode" class="font-weight-bold">Marital Status : {{ $employee_info->marital_status == 'Married' ? 'Married' : 'Single' }}</label> --}}
                                                    </div>
                                    ...
                                    <div class="col-10">
                                        <div class="card-body" style="padding: 0px;">
                                            <ul class="nav nav-tabs nav-tabs1" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active"  style="padding: 7px !important;"  id="personal-info-tabv" data-toggle="tab" href="#personal-infov" role="tab" aria-controls="personal-infov" aria-selected="false">Personal Info</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link "  style="padding: 7px !important;" id="contact-info-tabv" data-toggle="tab" href="#contact-infov" role="tab" aria-controls="contact-infov" aria-selected="false">Emergency Contact</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link "  style="padding: 7px !important;" id="job-info-tabv" data-toggle="tab" href="#job-infov" role="tab" aria-controls="job-infov" aria-selected="false">Job Info</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link  " style="padding: 7px !important;"  id="policy-tabv" data-toggle="tab" href="#policyv" role="tab" aria-controls="policyv" aria-selected="true">Policy</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link  " style="padding: 7px !important;"  id="vacation-tab" data-toggle="tab" href="#vacation" role="tab" aria-controls="vacation" aria-selected="true">Vacation</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link  " style="padding: 7px !important;"  id="attendance-tab" data-toggle="tab" href="#attendance" role="tab" aria-controls="attendance" aria-selected="true">Attendance</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link  " style="padding: 7px !important;"  id="files-tabv" data-toggle="tab" href="#filesv" role="tab" aria-controls="filesv" aria-selected="true">Document</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link  " style="padding: 7px !important;"  id="notice-tab" data-toggle="tab" href="#notice" role="tab" aria-controls="notice" aria-selected="true">Notice</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link  " style="padding: 7px !important;"  id="password-tab" data-toggle="tab" href="#password_" role="tab" aria-controls="password_" aria-selected="true">Change Password</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a href="#" title="Print" onclick="handlePrintClick('modal-body-print', 0)" class="btn btn-icon btn-info float-right  cursor-pointer"><i class='bx bx-printer'></i> </a>
                                                </li>
                                            ...
                                            <div class="tab-content tab-content1" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="personal-infov" role="tabpanel" aria-labelledby="personal-info-tabv">
                                                {{-- Personal Information --}}
                                                    <div class="row">
                                                        <div class="col-md-12 col-12 changeColStyle pl-1">
                                                            <h5 style="color: #475f7b;margin-top: 0.5rem;;font-size:19px; margin-left:4px;">PERSONAL INFORMATION</h5>
                                                        </div>
                                                            ...
                                                            <div class="card pb-1 pt-1">
                                                                <div class="row mx-0" >
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <input style="background-color: #F2F4F4; !important" type="text" readonly class="form-control inputFieldHeight" style="border:none" readonly  name="first_name"
                                                                            ...
                                                                            <input style="background-color: #F2F4F4; !important"  readonly type="text" autocomplete="off" class="form-control inputFieldHeightr"style="border:none"   value="{{date('d/m/Y', strtotime($employee_info->dob))}}"
                                                                            placeholder="DD/MM/YY" name="dob"readonly>
                                                                            <label for="mode">Gender</label>
                                                                            <input style="background-color: #F2F4F4; !important"  readonly type="text" value="{{$employee_info->gender =='Male' ? 'Male' : 'Female' }}" class="form-control inputFieldHeight">

                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label for="mode"> Nationality</label>
                                                                            <input style="background-color: #F2F4F4; !important"  readonly type="text" value="{{$employee_info->nationality}}" class="form-control inputFieldHeight "style="border:none" readonl name="nationality"  id="nationality"readonly>
                                                                            <label for="mode">Marital Status </label>
                                                                            <input style="background-color: #F2F4F4; !important"  readonly type="text"  value=" {{'Married' == $employee_info->marital_status ? 'Married':'Single' }}" class="form-control inputFieldHeight" style="border:none" readonly  name="kids_no" id="kids_no"readonly>
                                                            ...
                                                            <div class="card pb-1 pt-1">
                                                                <div class="row mx-0">
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <input style="background-color: #F2F4F4; !important"  readonly type="text" value="{{$employee_info->blood_group}}" class="form-control inputFieldHeight "style="border:none" readonl name="nationality"  id="nationality"readonly>
                                                                    </div>

                                                                    <div class="col-6">
                                                                        <label for="mode">Address (IN UAE) </label>
                                                                        <input style="background-color: #F2F4F4; !important"  readonly type="text" value="{{$employee_info->present_address}}" class="form-control inputFieldHeight" style="border:none" readonly  name="present_address"id="present_address"readonly>
                                                                    </div>

                                                                    <div class="col-6">
                                                                        <label for="mode">No. of kids </label>
                                                                        <input style="background-color: #F2F4F4; !important"  readonly type="text"  value="{{$employee_info->kids_no}}" class="form-control inputFieldHeight" style="border:none" readonly  name="kids_no" id="kids_no"readonly>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label for="mode">Joining Date </label>
                                                                        <input style="background-color: #F2F4F4; !important" type="text" readonly value="{{date('d/m/Y', strtotime($employee_info->joining_date))}}" class="form-control inputFieldHeight "
                                                                            autocomplete="off" name="joining_date" style="font-size:12px; border:none"placeholder="DD/MM/YY"  readonly>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label for="mode">Current Date</label>
                                                                        <input style="background-color: #F2F4F4; !important"  readonly type="text"  value="{{date('d/m/Y')}}" class="form-control inputFieldHeight" style="border:none" readonly  name="health_status"id="health_status" readonly>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        @php
                                                                        ...
                                                                        <input style="background-color: #F2F4F4; !important"  readonly type="text"  value="{{ $years }} years, {{ $months }} months, and {{ $days }} days." class="form-control inputFieldHeight" style="border:none" readonly  name="health_status"id="health_status" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="contact-infov" role="tabpanel" aria-labelledby="contact-info-tabv">
                                                     ...
                                                     <div class="row">
                                                        <div class="col-md-12 col-12 changeColStyle pl-1">
                                                            <h5 style="color: #475f7b;margin-top: 0.5rem;;font-size:19px; margin-left:4px">EMERGENCY CONTACT</h5>
                                                        </div>
                                                            ...
                                                            <div class="card pb-1 pt-1">
                                                                <div class="row mx-0">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input style="background-color: #F2F4F4; !important" type="text"value="{{$employee_info->em_name_local}}" class="form-control inputFieldHeight" name="em_name_local" id="em_name_local"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">

                                                                        <label for="mode">Email Address(Local)<sup class="text-danger">*</sup></label>
                                                                        <input style="background-color: #F2F4F4; !important" type="email"  value="{{$employee_info->em_email_local}}"class="form-control inputFieldHeight" name="em_email_local" id="em_email_local"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode"> Phone Number ( Local )<sup class="text-danger">*</sup></label>
                                                                        <input style="background-color: #F2F4F4; !important" type="text" value="{{$employee_info->em_contact_number_local}}" class="form-control inputFieldHeight" name="em_contact_number_local"readonly>
                                                                    </div>


                                                                    <div class="col-md-6">
                                                                        <label for="mode">City (Local)<sup class="text-danger">*</sup></label>
                                                                        <input style="background-color: #F2F4F4; !important" type="text" value="{{$employee_info->em_city_local}}" class="form-control inputFieldHeight " name="em_city_local"  id="em_city_local"readonly>

                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode"> Country (Local)<sup class="text-danger">*</sup></label>
                                                                        <select style="background-color: #F2F4F4; !important" name="em_country_local" id="em_country_local"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input style="background-color: #F2F4F4; !important" type="text" value="{{$employee_info->em_parmanent_address_local}}" class="form-control inputFieldHeight " name="em_parmanent_address_local"  id="em_parmanent_address_local"readonly>
                                                            ...
                                                            <div class="card pb-1 pt-1" style="height: 197px;">
                                                                <div class="row mx-0">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input style="background-color: #F2F4F4; !important"  type="text"value="{{$employee_info->em_name_origin}}" class="form-control inputFieldHeight" name="em_name_origin" id="em_name_origin"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">

                                                                        <label for="mode">Email Address(Origin)<sup class="text-danger">*</sup></label>
                                                                        <input style="background-color: #F2F4F4; !important"  type="email"  value="{{$employee_info->em_email_origin}}"class="form-control inputFieldHeight" name="em_email_origin" id="em_email_origin"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode"> Phone Number ( Origin )<sup class="text-danger">*</sup></label>
                                                                        <input style="background-color: #F2F4F4; !important"  type="text" value="{{$employee_info->em_contact_number_origin}}" class="form-control inputFieldHeight" name="em_contact_number_origin"readonly>
                                                                    </div>


                                                                    <div class="col-md-6">
                                                                        <label for="mode">City (Origin)<sup class="text-danger">*</sup></label>
                                                                        <input style="background-color: #F2F4F4; !important"  type="text" value="{{$employee_info->em_city_origin}}" class="form-control inputFieldHeight " name="em_city_origin"  id="em_city_origin"readonly>

                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode"> Country (Origin)<sup class="text-danger">*</sup></label>
                                                                        <select  style="background-color: #F2F4F4; !important"  name="em_country_origin" id="em_country_origin"
                                                                            class="form-control common-select2 errorr-abcd"
                                                                            style="width: 100% !important" readonly>
                                                                            <option value="">Select ...</option>
                                                                            @foreach ($countries as $country)
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input  style="background-color: #F2F4F4; !important"  type="text" value="{{$employee_info->em_parmanent_address_origin}}" class="form-control inputFieldHeight " name="em_parmanent_address_origin"  id="em_parmanent_address_local"readonly>
                                                ...
                                                <div class="tab-pane fade" id="job-infov" role="tabpanel" aria-labelledby="job-info-tabv">
                                                     <div class="row">
                                                        <div class="col-md-12 col-12 changeColStyle pl-1">
                                                            <h5 style="color: #475f7b;margin-top: 0.5rem;;font-size:19px; margin-left:4px">JOB INFORMATION </h5>
                                                        </div>
                                                        <div class=" col-12 col-sm-6 col-md-6 ">
                                                            <div class="card pb-1 pt-1">
                                                                <div class="row mx-0">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input readonly type="text" value="{{$employee_info->job_title}}" class="form-control inputFieldHeight" style="border:none" readonly  name="job_title" id="job_title"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode"> JOB DESCRIPTION</label>
                                                                        <input readonly type="text" value="{{$employee_info->job_description}}" class="form-control inputFieldHeight" style="border:none" readonly  name="job_description"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode">Visa Issue</label>
                                                                        <input readonly type="text" value="{{date('d/m/Y', strtotime($employee_info->vissa_issue))}}" autocomplete="off" class="form-control inputFieldHeight "style="border:none" readonly  placeholder="DD/MM/YY" name="vissa_issue" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode">Passport Number</label>
                                                                        <input readonly type="text"  value="{{$employee_info->passport_number}}"class="form-control inputFieldHeight" style="border:none" readonly  name="passport_number"  id="passport_number"readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="mode">Visa Expiriy</label>
                                                                        <input readonly type="text"  value="{{date('d/m/Y', strtotime($employee_info->visa_expiry_date))}}"autocomplete="off" class="form-control inputFieldHeight "style="border:none" readonly  placeholder="DD/MM/YY" name="visa_expiry_date" readonly>

                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="last_visite" class="col-form-label">Last Visite Date</label>
                                                                        <input  type="text" autocomplete="off" placeholder="DD/MM/YYY" name="last_visite" value="{{date('d/m/Y', strtotime($employee_info->last_visite))}}" readonly id="last_visite" class="form-control datepicker">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row mx-0">
                                                                    ...
                                                                    {{-- <div class="col-md-6">
                                                                        ...
                                                                        <select readonly name="department" id="department"
                                                                            class="form-control common-select2" style="width: 100% !important; border:none"
                                                                            readonly>
                                                                            <option value="">Select ...</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="mode">Joining Date </label>
                                                                        <input readonly type="text" value="{{date('d/m/Y', strtotime($employee_info->joining_date))}}" class="form-control inputFieldHeight "
                                                                            autocomplete="off" name="joining_date" style="font-size:12px; border:none"
                                                                    ...
                                                                    <select readonly name="job_type" id="job_type" class="form-control common-select2"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="mode">Employee Basic Salary </label>
                                                                        <input readonly type="text" value="{{$employee_info->basic_salary}}" class="form-control inputFieldHeight "
                                                                            autocomplete="off" name="joining_date" style="font-size:12px; border:none"
                                                                            placeholder="DD/MM/YY"  readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <select readonly name="job_status" id="job_type" class="form-control common-select2"
                    ...
                    <div class="tab-pane fade" id="bank-accountv" role="tabpanel" aria-labelledby="bank-account-tabv">
                        ...
                        <input type="submit"  value=" Employee Save" class="form-control btn btn-success" style=" width: 160px; float: right; margin-top: 10px;">
                                                ...
                                                <div class="tab-pane fade" id="policyv" role="tabpanel" aria-labelledby="policy-tabv">
                                                    <div class="row">
                                                        <div class="col-md-12 col-12 changeColStyle pl-1">
                                                            <h5 style="color: #475f7b;margin-top: 0.5rem;;font-size:19px; margin-left:4px">POLICY INFORMATION </h5>
                                                        </div>
                                                        <div class="col-12 col-sm-6 col-md-6">
                                                            <div class="card pb-1 pt-1">
                                                                <div class="row mx-0">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select readonly name="policy_type" id="policy_typeu" class="form-control policy_typeu">
                                                                            <option value="">Select..</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input readonly type="text" autocomplete="off" placeholder="DD/MM/YYYY" value="{{ isset($emp_policy->effect_date) ? date('d/m/Y', strtotime($emp_policy->effect_date)) : '' }}" name="effect_date" class="form-control datepicker">
                                                                    </div>

                                                                    <div class="col-md-6">
                                                                        <label for="air_ticket_eligibility" class="col-form-label">Air Ticket (Yes/No)</label>
                                                                        <select readonly name="air_ticket_eligibility" id="air_ticket_eligibility" class="form-control">
                                                                            {{-- <option value="">Select..</option> --}}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select readonly name="apply_over_time" id="apply_over_time" class="form-control">
                                                                            {{-- <option value="">Select..</option> --}}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select readonly name="vacation_paid_or_unpaid" id="vacation_paid_or_unpaid" class="form-control">
                                                                            {{-- <option value="">Select..</option> --}}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select readonly name="vacation_type" id="vacation_type" class="form-control">
                                                                            {{-- <option value="">Select..</option> --}}
                                                                   ...
                                                                   {{--
                                                                    <div class="col-md-6">
                                                                        <label for="minimum_day_for_ticket_price" class="col-form-label">Minimum Days for Ticket Price</label>
                                                                        <input readonly type="number" name="minimum_day_for_ticket_price" value="{{ isset($emp_policy->minimum_day_for_ticket_price) ? $emp_policy->minimum_day_for_ticket_price : '' }}" id="minimum_day_for_ticket_price" class="form-control">
                                                                    </div> --}}
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input required type="number"  name="minimun_vacation_priod"  value="{{isset($emp_policy->minimun_vacation_priod) ? $emp_policy->minimun_vacation_priod : '' }}" id="minimun_vacation_priod" class="form-control">
                                                                    </div>
                                                               ...
                                                               {{--
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input readonly type="text" name="time_zone" value="{{ isset($emp_policy->time_zone) ? $emp_policy->time_zone : '' }}" id="time_zone" class="form-control">
                                                                    </div> --}}
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <textarea name="description" id="description" class="form-control" rows="3">{{ isset($emp_policy->description) ? $emp_policy->description : '' }}</textarea>
                                                                    </div>
                                                        ...
                                                        <div class="col-12 col-sm-6 col-md-6">
                                                            <div class="card pb-1 pt-1">
                                                                <div class="row mx-0">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="salary_loss" class="col-form-label">Salary Loss Rate ( Basic salary percentanbe of day)</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input readonly type="time" name="m_ref_in_time" value="{{ isset($emp_policy->m_ref_in_time) ? $emp_policy->m_ref_in_time : '' }}" id="m_ref_in_time" class="form-control">
                                                                    </div>

                                                                    <div class="col-md-6">
                                                                        <label for="m_ref_out_time" class="col-form-label">Morning Reference Office Out Time</label>
                                                                        <input readonly type="time" name="m_ref_out_time" value="{{ isset($emp_policy->m_ref_out_time) ? $emp_policy->m_ref_out_time : '' }}" id="m_ref_out_time" class="form-control">
                                                                    </div>
                                                ...
                                                <div class="tab-pane fade  " id="attendance" role="tabpanel" aria-labelledby="attendance-tab">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-12 col-md-12">
                                                                <h5 style="color: #000;margin: 0.5rem;;font-size:19px">Attendance of {{ date('M Y')}}</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6 col-md-6">
                                                            <div class="card p-1">
                                                                <div class="row ">
                                                                    <div class="col-md-12">
                                                                        <a href="{{ asset('storage/upload/employee/'.$employee_info->employee_image)}}"target="blunk_" style=" color:#000">
                                                                            <img src="{{ asset('storage/upload/employee/'.$employee_info->employee_image)}}" id="employee_image_previewu" class="employee_image image-upload img-fluid rounded" alt="Image View" style="width:100%; height:300px; object-fit: cover;" alt="">
                                                                            <label style="" for="employee_image">PROFILE IMAGE</label>
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <a href="{{ asset('storage/upload/employee/'.$employee_info->emirates_image)}}" target="blunk_"style=" color:#000">
                                                                            <img src="{{ asset('storage/upload/employee/'.$employee_info->emirates_image)}}" id="emirates_image_previewu" class="emirates_image image-upload img-fluid rounded" alt="Image View" style="width:100%; height:300px; object-fit: cover;" alt="">
                                                        ...
                                                        <div class="col-12 col-sm-6 col-md-6">
                                                            <div class="card p-1">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <a href="{{ asset('storage/upload/employee/'.$employee_info->vissa_image)}}" target="blunk_"style=" color:#000">
                                                                            <img  src="{{ asset('storage/upload/employee/'.$employee_info->vissa_image)}}" id="vissa_image_previewu" class="vissa_image image-upload img-fluid rounded"style="width:100%; height:300px; object-fit: cover;"alt="">
                                                                            <label style="" for="vissa_image">VISA IMAGE</label>
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <a href="{{ asset('storage/upload/employee/'.$employee_info->image)}}"target="blunk_"style=" color:#000">
                                                                            <img src="{{ asset('storage/upload/employee/'.$employee_info->image)}}" id="_image_previewu" class="_image image-upload img-fluid rounded" alt="Image View" style="width:100%; height:300px; object-fit: cover;" alt="">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($document_lists as $item)
                                                                            <tr id="{{'tr'.$item->id}}">
                                                                                <td>{{$item->name}}</td>
                                                                                <td>
                                                                                    <a href="{{ asset('storage/upload/other-documents/'.$item->filename) }}" target="_blank" style="color:#000;">
                                                                                        <img src="{{ asset('storage/upload/other-documents/'.$item->filename) }}" class="img-fluid" style=" height:100px; object-fit: cover;">
                                                                                    </a>
                                                                                </td>
                                                                           </tr>
                                                                        @endforeach
                                                  ...
                                                  {{-- passwoard chnage --}}
                                                  <div class="tab-pane fade" id="password_" role="tabpanel" aria-labelledby="password-tab">
                                                    <div class="row">
                                                       <div class="col-md-12 col-12 changeColStyle pl-1">
                                                           <h5 style="color: #475f7b;margin-top: 0.5rem;;font-size:19px; margin-left:4px">Change Password  </h5>
                                                       </div>
                                                       <div class=" col-12 col-sm-12 col-md-12 ">
                                                           <div class="card pb-1 pt-1">
                                                               <div class="row mx-0">
                                                                   <div class="col-md-6">
                                                                       <label for="mode">Old Password</label>
                                                                       <input  type="hidden"  class="form-control inputFieldHeight" value="{{$employee_info->email}}" name="email_password_change" >

                                                                       <input  type="password"  class="form-control inputFieldHeight"  name="old_password" >
                                                                   </div>
                                                                   <div class="col-md-6">
                                                                       <label for="mode">New Password</label>
                                                                       <input  type="passwoard"  class="form-control inputFieldHeight"   name="new_password">
                                                                   </div>
                                                                   <div class="col-md-6">
                                                                       <label for="mode">Confirm Password</label>
                                                                       <input  type="password" class="form-control inputFieldHeight "name="confirm_password" >
                                                                   </div>
                                                                   <input type="botton"  value="Password Change" class="form-control btn change-password" style=" width: 187px;float: right; margin-top: 24px;background: #00bdff;color: #fff;">
...
<div class="d-none" >
    <div class="modal-body" id="modal-body-print">
        <div class="card-body" style="padding: 0px;">
            <h5 style="color: #475f7b;margin-top: 0.5rem;;font-size:19px; margin-left:4px; text-align:center">EMPLOYEE INFORMATION</h5>
            <div class="row">
                <div class="col-2">
                    <div class="row">
                        <!-- Left Section: Employee Image, Name, and ID -->
                        <div class="col-12 text-left ">
                            <a href="{{ asset('storage/upload/employee/'.$employee_info->employee_image) }}" target="_blank" style="color:#000;">
                                <img src="{{ asset('storage/upload/employee/'.$employee_info->employee_image) }}" class="img-fluid rounded-circle" style="width:150px; height:150px; object-fit: cover;" alt="Employee Image">
                            </a>
                            <h6 style="font-size: 15px;color: #475f7b;font-weight:900" class="mt-1">{{ $employee_info->full_name }}</h6>
                            <h6 style="font-size: 14px;color: #475f7b;font-weight:900">  {{ $employee_info->job_title }}</h6>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <!-- Column Titles (Left) -->
                                <div class="col-12">
                                    <label for="mode"  style="font-size: 15px;color: #475f7b; font-weight:900 !important"  class="font-weight-bold">First Name : <span class="text-right"> {{ $employee_info->first_name }}</span></label>
                                    <label for="mode"  style="font-size: 15px;color: #475f7b; font-weight:900 !important"  class="font-weight-bold">DOB :{{ date('d/m/Y', strtotime($employee_info->dob)) }}</label>
                                    <label for="mode"  style="font-size: 15px;color: #475f7b; font-weight:900 !important"  class="font-weight-bold">Gender : {{ $employee_info->gender == 'Male' ? 'Male' : 'Female' }}</label>
                                    <label for="mode"  style="font-size: 15px;color: #475f7b; font-weight:900 !important"  class="font-weight-bold">Blood Group : {{ $employee_info->blood_group }}</label>
                                    <label for="mode"  style="font-size: 15px;color: #475f7b; font-weight:900 !important"  class="font-weight-bold">Marital Status : {{ $employee_info->marital_status == 'Married' ? 'Married' : 'Single' }}</label>
                                </div>
                    ...
                    <div class="card-body" style="padding: 0px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="row mx-0">
                                    <div class="col-md-6">
                                        <div><strong>First Name:</strong> <span>{{$employee_info->first_name}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Middle Name:</strong> <span>{{$employee_info->middle_name}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Last Name:</strong> <span>{{$employee_info->last_name}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Date of Birth:</strong> <span>{{ date('d/m/Y', strtotime($employee_info->dob)) }}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Gender:</strong> <span>{{ $employee_info->gender }}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Nationality:</strong> <span>{{$employee_info->nationality}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Address (IN UAE):</strong> <span>{{$employee_info->parmanent_address}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Blood Group:</strong> <span>{{$employee_info->blood_group}}</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="row mx-0">
                                    ...
                                    <div class="col-md-6">
                                        <div><strong>Tel Number:</strong> <span>{{$employee_info->contact_number}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>No. of Kids:</strong> <span>{{$employee_info->kids_no}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Joining Date:</strong> <span>{{ date('d/m/Y', strtotime($employee_info->joining_date)) }}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Current Date:</strong> <span>{{ date('d/m/Y') }}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Years of Service:</strong> <span>{{ $years }} years, {{ $months }} months, and {{ $days }} days.</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="row mx-0">
                                    <div class="col-md-6">
                                        <div><strong>Name (Local):</strong> <span>{{$employee_info->em_name_local}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Email Address (Local):</strong> <span>{{$employee_info->em_email_local}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Phone Number (Local):</strong> <span>{{$employee_info->em_contact_number_local}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>City (Local):</strong> <span>{{$employee_info->em_city_local}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Country (Local):</strong>
                                            <span>
                                                @foreach ($countries as $country)
                                                    @if($country->id == $employee_info->em_country_local) {{$country->name}} @endif
                                                @endforeach
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Address (Local):</strong> <span>{{$employee_info->em_parmanent_address_local}}</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="row mx-0">
                                    <div class="col-md-6">
                                        <div><strong>Name (Origin):</strong> <span>{{$employee_info->em_name_origin}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Email Address (Origin):</strong> <span>{{$employee_info->em_email_origin}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Phone Number (Origin):</strong> <span>{{$employee_info->em_contact_number_origin}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>City (Origin):</strong> <span>{{$employee_info->em_city_origin}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Country (Origin):</strong>
                                            <span>
                                                @foreach ($countries as $country)
                                                    @if($country->id == $employee_info->em_country_origin) {{$country->name}} @endif
                                                @endforeach
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Address (Origin):</strong> <span>{{$employee_info->em_parmanent_address_origin}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="row mx-0">
                                    <div class="col-md-6">
                                        <div><strong>JOB TITLE:</strong> <span>{{$employee_info->job_title}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>JOB DESCRIPTION:</strong> <span>{{$employee_info->job_description}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Visa Issue:</strong> <span>{{date('d/m/Y', strtotime($employee_info->vissa_issue))}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Passport Number:</strong> <span>{{$employee_info->passport_number}}</span></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div><strong>Visa Expiry:</strong> <span>{{date('d/m/Y', strtotime($employee_info->visa_expiry_date))}}</span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mx-0">
                                    <div class="col-md-6">
                                        <div><strong>Department:</strong>
                                            <span>
                                                @foreach ($divisions as $division)
                                                    @if($division->id == $employee_info->division) {{$division->name}} @endif
                                                @endforeach
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div><strong>Job Status:</strong>
                                            <span>
                                                @foreach ($job_types as $job_type)
                                                    @if($job_type->id == $employee_info->job_type) {{$job_type->type}} @endif
                                                @endforeach
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="row mx-0">
                                    ...
                                    <!-- Policy Type -->
                                    <div class="col-md-6">
                                        <div><strong>Policy Type:</strong> <span>{{ isset($emp_policy->policy_type) ? $emp_policy->policy_type : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Effective Date -->
                                    <div class="col-md-6">
                                        <div><strong>Effective Date:</strong> <span>{{ isset($emp_policy->effect_date) ? date('d/m/Y', strtotime($emp_policy->effect_date)) : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Air Ticket Eligibility -->
                                    <div class="col-md-6">
                                        <div><strong>Air Ticket (Yes/No):</strong> <span>{{ isset($emp_policy->air_ticket_eligibility) ? $emp_policy->air_ticket_eligibility : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Cash Redeem -->
                                    <div class="col-md-6">
                                        <div><strong>Cash Redeem:</strong> <span>{{ isset($emp_policy->apply_over_time) ? $emp_policy->apply_over_time : 'Not Available' }}</span></div>
                                    </div>
                                        <!-- basic-salary-->
                                        <div class="col-md-6">
                                    ...
                                    <!-- Vacation Paid Type -->
                                    <div class="col-md-6">
                                        <div><strong>Vacation Paid Type:</strong> <span>{{ isset($emp_policy->vacation_paid_or_unpaid) ? $emp_policy->vacation_paid_or_unpaid : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Leave Type -->
                                    <div class="col-md-6">
                                        <div><strong>Leave Type:</strong> <span>{{ isset($emp_policy->vacation_type) ? $emp_policy->vacation_type : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Ticket Allowance (Cash) -->
                                    <div class="col-md-6">
                                        <div><strong>Ticket Allowance (Cash):</strong> <span>{{ isset($emp_policy->ticket_price_percentage) ? $emp_policy->ticket_price_percentage : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Minimum Leave Period -->
                                    <div class="col-md-6">
                                        <div><strong>Minimum Leave Period (Years):</strong> <span>{{ isset($emp_policy->minimun_vacation_priod) ? $emp_policy->minimun_vacation_priod : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Number of Yearly Vacations -->
                                    <div class="col-md-6">
                                        <div><strong>Number of Yearly Leave:</strong> <span>{{ isset($emp_policy->number_of_yearly_vacation) ? $emp_policy->number_of_yearly_vacation : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Description -->
                                    <div class="col-md-12">
                                        <div><strong>Description:</strong> <span>{{ isset($emp_policy->description) ? $emp_policy->description : 'Not Available' }}</span></div>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="row mx-0">
                                    ...
                                    <div class="col-md-6">
                                        <div><strong>Maximum Time for Attendance (Minutes):</strong> <span>{{ isset($emp_policy->maximum_time_for_attendace) ? $emp_policy->maximum_time_for_attendace : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Late Type -->
                                    <div class="col-md-6">
                                        <div><strong>Late Type:</strong> <span>{{ isset($emp_policy->late_type) ? $emp_policy->late_type : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Minimum Hours for Late -->
                                    <div class="col-md-6">
                                        <div><strong>Minimum Hours for Late:</strong> <span>{{ isset($emp_policy->minimum_hours_for_late) ? $emp_policy->minimum_hours_for_late : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Salary Loss Rate -->
                                    <div class="col-md-6">
                                        <div><strong>Salary Loss Rate:</strong> <span>{{ isset($emp_policy->salary_loss) ? $emp_policy->salary_loss : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Apply Over Time -->
                                    <div class="col-md-6">
                                        <div><strong>Apply Over Time:</strong> <span>{{ isset($emp_policy->cash_redeem) ? $emp_policy->cash_redeem : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Overtime Rate (Percentage) -->
                                    <div class="col-md-6">
                                        <div><strong>Overtime Rate (Percentage):</strong> <span>{{ isset($emp_policy->overtime_rate) ? $emp_policy->overtime_rate : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Minimum Hours for Overtime -->
                                    <div class="col-md-6">
                                        <div><strong>Minimum Hours for Overtime:</strong> <span>{{ isset($emp_policy->min_hours_for_overtime) ? $emp_policy->min_hours_for_overtime : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Late Grace Time -->
                                    <div class="col-md-6">
                                        <div><strong>Late Grace Time (Minutes):</strong> <span>{{ isset($emp_policy->late_grace_time) ? $emp_policy->late_grace_time : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Morning Reference In Time -->
                                    <div class="col-md-6">
                                        <div><strong>Morning Reference In Time:</strong> <span>{{ isset($emp_policy->m_ref_in_time) ? $emp_policy->m_ref_in_time : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Morning Reference Out Time -->
                                    <div class="col-md-6">
                                        <div><strong>Morning Reference Out Time:</strong> <span>{{ isset($emp_policy->m_ref_out_time) ? $emp_policy->m_ref_out_time : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Evening Reference In Time -->
                                    <div class="col-md-6">
                                        <div><strong>Evening Reference In Time:</strong> <span>{{ isset($emp_policy->e_ref_in_time) ? $emp_policy->e_ref_in_time : 'Not Available' }}</span></div>
                                    </div>

                                    <!-- Evening Reference Out Time -->
                                    <div class="col-md-6">
                                        <div><strong>Evening Reference Out Time:</strong> <span>{{ isset($emp_policy->e_ref_out_time) ? $emp_policy->e_ref_out_time : 'Not Available' }}</span></div>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="card p-1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="{{ asset('storage/upload/employee/'.$employee_info->vissa_image)}}" target="blunk_"style=" color:#000">
                                                <img  src="{{ asset('storage/upload/employee/'.$employee_info->vissa_image)}}" id="vissa_image_previewu" class="vissa_image image-upload img-fluid rounded" alt="Image View" style="width:100%; height:300px; object-fit: cover;"alt="">
                                                <label style="" for="vissa_image">VISA IMAGE</label>
                                            </a>
                                        </div>
                                        <div class="col-md-12">
...
$(document).ready(function() {
    $('.change-password').on('click', function() {
        // Get input values
        let email = $('input[name="email_password_change"]').val(); // Email field
        ...
        // Send AJAX request
        $.ajax({
            url: '{{route('employee-password-change')}}', // Update with your backend route
            type: 'POST',
            data: {
    ...
    $(document).on('change', '.policy_type,.policy_typeu', function(e) {
        ...
        if (value === 'Default') {
            ...
            $.ajax({
                ...
                processData: false,
                success: function(response) {
                    console.log(response); // Debugging log for AJAX response

                    $('[name="air_ticket_eligibility"]').val(response.air_ticket_eligibility).prop('readonly', true).change();
                    $('[name="description"]').val(response.description).prop('readonly', true);
                    $('[name="cash_redeem"]').val(response.cash_redeem).prop('readonly', true);
                    $('[name="vacation_type"]').val(response.vacation_type).prop('readonly', true);
                    $('[name="vacation_paid_or_unpaid"]').val(response.vacation_paid_or_unpaid).prop('readonly', true).change();
                    $('[name="minimum_day_for_ticket_price"]').val(response.minimum_day_for_ticket_price).prop('readonly', true);
                    $('[name="ticket_price_percentage"]').val(response.ticket_price_percentage).prop('readonly', true);
                    $('[name="late_type"]').val(response.late_type).prop('readonly', true).change();
                    $('[name="minimum_day_for_late"]').val(response.minimum_day_for_late).prop('readonly', true);
                    $('[name="minimum_hours_for_late"]').val(response.minimum_hours_for_late).prop('readonly', true);
                    $('[name="salary_loss"]').val(response.salary_loss).prop('readonly', true);

                    $('[name="overtime_rate"]').val(response.overtime_rate).prop('readonly', true);
                    $('[name="min_hours_for_overtime"]').val(response.min_hours_for_overtime).prop('readonly', true);
                    $('[name="late_grace_time"]').val(response.late_grace_time).prop('readonly', true);
                    $('[name="number_of_yearly_vacation"]').val(response.number_of_yearly_vacation).prop('readonly', true);
                    $('[name="maximum_time_for_attendace"]').val(response.maximum_time_for_attendace).prop('readonly', true);

                    // Time fields with conversion
                    $('[name="m_ref_in_time"]').val(convertToTimeInputFormat(response.m_ref_in_time)).prop('readonly', true);
                    $('[name="m_ref_out_time"]').val(convertToTimeInputFormat(response.m_ref_out_time)).prop('readonly', true);
                    $('[name="e_ref_in_time"]').val(convertToTimeInputFormat(response.e_ref_in_time)).prop('readonly', true);
                    $('[name="e_ref_out_time"]').val(convertToTimeInputFormat(response.e_ref_out_time)).prop('readonly', true);

                    $('[name="time_zone"]').val(response.time_zone).prop('readonly', true);
                    $('[name="apply_over_time"]').val(response.apply_over_time).prop('readonly', true);
