...
<style>
    ...
    .flex-row-reverse .mIconStyleChange a {
        width: 40px;
        height: 40px;
 ...
 <section class="print-hideen border-bottom" style="padding: 0px 32px; background-color:#475f7b;">
    <div class="d-flex justify-content-between align-item-center">
        <h5 style="font-family:Cambria;font-size: 1.6rem; margin-top:8px;margin-left:13px;color:#ececec !important;"><b>View Employee Profile</b> </h5>
        <div class="d-flex flex-row-reverse">
            ...
            <div class="mIconStyleChange">
                <a href="#" title="Print" onclick="handlePrintClick('modal-body-print', 0)"
                    class="btn btn-icon btn-info btn-sm"><i class='bx bx-printer'></i> </a>
            </div>
...
<div class="modal-body" id="modal-body">
    <div class="row">
        ...
        <div class="col-10">
            <div class="card-body custom-tab" style="padding: 0px;">
                <ul class="nav nav-tabs nav-tabs1 custome-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" style="padding: 7px !important;" id="personal-info-tabv"
                            ...
                            aria-selected="false">Employee Info</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="padding: 7px !important;" id="important-tab" data-toggle="tab"
                            href="#important" role="tab" aria-controls="important" aria-selected="true"> Important </a>
                    </li>
                ...
                <div class="tab-content tab-content1" id="myTabContent">
                            ...
                            <div class=" col-12 col-sm-6 col-md-6 ">
                                <div class="card pb-1 pt-1">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            <label for="mode">Last Name</label>
                                            <input readonly type="text" class="form-control inputFieldHeight"
                                ...
                                <div class="card pb-1 pt-1">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input readonly type="text"
                                                value="{{$employee_info->visa_expiry_date ? date('d/m/Y', strtotime($employee_info->visa_expiry_date)) : ''}}"
                                                autocomplete="off" class="form-control inputFieldHeight "
                                        ...
                                        <div class="col-md-6 d-none">
                                            <label for="last_visite" class="col-form-label"> Last Visit Date </label>
                                            <input type="text" autocomplete="off" placeholder="DD/MM/YYY"
                                                name="last_visite"
                                                value="{{$employee_info->last_visite ? date('d/m/Y', strtotime($employee_info->last_visite)) : ''}}"
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select readonly name="job_status" id="job_type"
                                                ...
                                                <option value="2" {{"2"==$employee_info->job_status ? 'selected':''
                                                    }}>Leave</option>

                                            </select>
                                        </div>

                                        <div class="col-md-6" style="padding: 0 5px; {{$employee_info->job_status == '2' ?'':'display:none;'}}">
                                            <label style="white-space: nowrap;"> Leave Date <sup
                                                class="text-danger leave_date-span"></label>

                                            <input type="text" class="form-control datepicker leave_date" name="leave_date" disabled
                                ...
                                <div class="card pb-1 pt-1">
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label for="mode">Email Addres </label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="mode"> Phone Number </label>
                                            <input style="background-color: #F2F4F4; !important" type="text"
                        ...
                        <div class="row">
                            ...
                            <div class=" col-12 col-sm-6 col-md-6 ">
                                <div class="card pb-1 pt-1">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            <label for="mode">ACCOUNT NUMBER</label>
                            ...
                            <div class=" col-12 col-sm-6 col-md-6 ">
                                <div class="card pb-1 pt-1" >
                                    <div class="row mx-0">
                                        <div class="col-md-6">
                                            <label for="mode">ACCOUNT NAME</label>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="card pb-1 pt-1">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            <label for="minimun_vacation_priod" class="col-form-label">Min Leave
                                                Period (Year)</label>
                                                <select readonly required name="minimun_vacation_priod" id="minimun_vacation_priod" class="form-control">
                                                    <option value="">Select..</option>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <div class="card pb-1 pt-1">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-6">
                                            <label for="minimum_hours_for_late" class="col-form-label">Minimum Allowable (Hrs) </label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="min_hours_for_overtime" class="col-form-label">Minimum Hrs for (OT) </label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="m_ref_out_time" class="col-form-label"> 1st shift (END)
                                                Out Time</label>
                            ...
                            <div class="col-12 col-sm-12 col-md-12">
                                ...
                                <div class="card p-1">
                                    ...
                                    // Get the most recent EmployeePolicy based on the effective date
                                        ...
                                        @endphp
                                        {{-- @dd($total_leave) --}}
                                        {{-- @dd($emp_policy->minimun_vacation_priod) --}}
                                        <div class="table-responsive" id="employee_table_data"
                                            ...
                                            <div class="list-group">
                                                ...
                                                <div class="list-group-item">
                                                    ...
                                                    @if($currentDate <  $nextVisitDate)
                                                    {{ $diffYears }} years, {{ $diffMonths }} months, {{ $diffDays }}
                                                    days.
                                                    @else
                                                    The next visit date has passed.
                                                    @endif
                        ...
                        <div class="row">
                            @php
                                ...
                                if( $employee){
                                    ...
                                    $joiningDate = $employee_info->joining_date;
                                    $startYear = \Carbon\Carbon::parse($employee_info->joining_date)->year;
                                    $currentYear = now()->year;
                                    $attendance_years = range($startYear, $currentYear);
                                }
                            @endphp

                            <div class="col-12 col-sm-12 col-md-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 style="color: #000;margin: 0.5rem;font-size:19px">Attendance </h5>
                                    @if($employee)
                                    <form class="attendance-search-form d-flex" action="{{route('employee.attendance.search',$employee->id)}}">
                                        <select class="form-control" name="attendance_year" id="attendance_year">
                                            @foreach($attendance_years as $attendance_year)
                                                <option value="{{$attendance_year}}">{{$attendance_year}}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <input type="text" class="form-control datepicker inputFieldHeight" id="attendance_date" name="attendance_date" value="{{date("d/m/Y")}}">
                    ...
                    <div class="tab-pane fade w-100" id="important" role="tabpanel" aria-labelledby="important-tab">
                        <div class="row">
                            @php
                                $employee = Employee::where('emp_id',$employee_info->emp_id)->first();
                                $pay_roll_months = [
                            ...
                            @endphp
                            @if($employee)
                            <div class="col-12 col-md-7 changeColStyle pl-1">
                                <div class="d-flex justify-content-between align-items-center">

                                    <input type="hidden" id="paysip_user_id" value="{{$employee->id}}">

                                    <div class="form-group w-100" style="width:100%;">

                                        <label for=""> Select Year   </label>

                                        <select name="payslip_year" id="payslip_year" class="form-control" style="width:100%; max-width: 230px;font-size:16px !important;">
                                            @foreach(collect($attendance_years)->sortDesc() as $attendance_year)
                                                <option value="{{ $attendance_year }}">{{ $attendance_year }}</option>
                                            @endforeach
                                        </select>
                                    </div>

                                    <div class="form-group w-100" style="width:100%; margin-left:15px; margin-right:15px;">
                                        <label for="">Month</label>
                                        <select name="payslip_month" id="payslip_month" class="form-control" style="width:100%; max-width: 230px; font-size:16px !important;">
                                            @foreach($pay_roll_months as $key => $pay_roll_month)
                                    ...
                                    <button class="btn btn-info" id="payroll-button" style="margin-top:10px;">  Search </button>
                                </div>
                            </div>

                            <div class="col-12 col-md-6">
                                <div class="card p-1 ml-1" id="payslip">
                                    <h5> Payslip </h5>
                                    <button class="payslip-title payslip-button" data-all="all">Download All Payslip </button>
                                    <div class="payslip-months d-flex">
                                        <button class="payslip-button" data-month="01">January</button>
                                        <button class="payslip-button" data-month="02">February</button>
                                        <button class="payslip-button" data-month="03">March</button>
                                        <button class="payslip-button" data-month="04">April</button>
                                        <button class="payslip-button" data-month="05">May</button>
                                        <button class="payslip-button" data-month="06">June</button>
                                        <button class="payslip-button" data-month="07">July</button>
                                        <button class="payslip-button" data-month="08">August</button>
                                        <button class="payslip-button" data-month="09">September</button>
                                        <button class="payslip-button" data-month="10">October</button>
                                        <button class="payslip-button" data-month="11">November</button>
                                        <button class="payslip-button" data-month="12">December</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card p-1 ml-1">
                                    ...
                                    <table class="table table-sm table-hover table-bordered"
                                        ...
                                        <tbody id="payroll-table-body">
                                            ...
                                            <tr>
                                                <td style="font-size: 15px;"> Current Salary </td>
...
<div class="d-none">
    ...
    <div class="id-card">
        ...
        <div class="id-card-header">
            ...
            <div class="photo-section" style="    margin-top: -3px;">
            <div class="photo">
                <!-- Use an actual image here if available -->
                <img src="{{asset('/img/ID_Card.png')}}" alt="Logo" class="logo1 photo" >
            </div>
            </div>
        </div>
