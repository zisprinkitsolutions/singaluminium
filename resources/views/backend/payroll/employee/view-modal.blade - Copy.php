        ...
        <div class="col-10">
            <div class="card-body " style="padding: 0px;">
                <ul class="nav nav-tabs nav-tabs1" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" style="padding: 7px !important;"
                            data-toggle="tab" href="#personal-infov" role="tab" aria-controls="personal-infov"
                            aria-selected="false">Employee Info</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " style="padding: 7px !important;" data-toggle="tab"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12 changeColStyle pl-1">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="form-group w-100" style="width:100%; max-width: 230px;">
                            ...
                            <div class="card p-1 ml-1" id="payslip">
                                ...
                                <div class="payslip-months d-flex flex-column">
