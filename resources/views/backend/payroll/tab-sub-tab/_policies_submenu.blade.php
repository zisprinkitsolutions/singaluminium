...
<div class="d-flex align-items-center gap-2">
    ...
    <a href="{{route("leave-policies.index")}}" class="btn btn-outline-secondary ml-1 nav-item nav-link {{ $activeMenu == 'leave-policy' ? 'bg-secondary text-white' :'text-dark' }}" role="tab" aria-controls="nav-contact" aria-selected="false">
        <div> Leave Entry </div>
    </a>
