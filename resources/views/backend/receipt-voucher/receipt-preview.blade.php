...
<div class="d-flex flex-row-reverse justify-content-center align-items-center py-2" >
    ...
    <div class="" style="">
        <a href="{{ route('receipt-voucher-delete', $recept) }}" class="btn btn-icon custom-action-btn btn-danger"
            onclick="event.preventDefault(); deleteAlert(this, 'About to delete receipt voucher. Please, confirm?');"
            title="Delete"><i class="bx bx-trash"></i> Delete</a>
    </div>

    <div class="" style="">
        <a href="{{ route('receipt-voucher-approve', $recept) }}" class="btn btn-icon custom-action-btn btn-success"
            onclick="event.preventDefault(); deleteAlert(this, 'About to approve voucher. Please, confirm?', 'approve');"
            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Approve"><i class="bx bx-check"></i> Approve</a>
    </div>

    <div class="" style="">
        <a href="{{ route('receipt-voucher-edit', $recept) }}" class="btn btn-icon custom-action-btn btn-primary edit-btn"
            title="Edit"><i class="bx bx-edit"></i> Edit</a>
    </div>
</div>
