                ...
                <div id="journaCreation" class="tab-pane bg-white active">
                    <section id="widgets-Statistics ">
                        <div class="d-flex justify-content-between align-items-center p-1">
                            @include('clientReport.report.vat_report_subheader', ['activeMenu' => 'output_vat'])
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row ml-2">
                                    ...
                                    <div class="col-md-3 col-padding-right pl-0">
                                        <a href="#" onclick="media_print('out_vat')" class="btn btn-icon btn-secondary"><i class="bx bx-printer"></i>Print</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="card-body pt-0 pb-0 daily-summery" id="out_vat">
                                @include('layouts.backend.partial.modal-header-info')
                                <h2 class="text-center">Output VAT Report</h2>
                                ...
                                <table class="table table-bordered table-sm text-center">
                                    <thead class="thead">
                                        <tr >
                                            <th style="text-align: center !important; width: 20%">CUSTOMER NAME</th>
                                    ...
                                    <tbody id="purch-body">
                                        ...
                                        <tr class="sale_view"  id="{{$item->id}}">
                                            ...
                                            <td style="text-align: center !important;">{{number_format($item->budget,2)}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{number_format($output_vats->sum('vat'),2)}}</td>
                                            <td></td>
                                        </tr>
                                    </tbody>
