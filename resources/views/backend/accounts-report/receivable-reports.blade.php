                        ...
                        <div class="content-body">
                            <section id="widgets-Statistics">
                                <div class="d-flex justify-content-between align-items-center print-hideen">
                                    @include('clientReport.report._financial_report_subheader', [ 'activeMenu' => 'receivable_reports'])
                                </div>
                                    ...
                                    <div class="card-body p-0" style="padding: 0 !important;">
                                        ...
                                        <table  class="table table-sm table-bordered table-hover">
                                            ...
                                            @foreach ($partys as $party)
                                                ...
                                                @endif --}}
                                                @foreach ($party->journal_record_receivable($party->id, $date, $from, $to) as $record)
                                                    @php
                                                    ...
                                                    @endphp
                                                        ...
                                                        <tr  class="trFontSize journalDetails" v-type="main" style="cursor: pointer;" id="{{ $record->journal_id }}">
                                                            ...
                                                            @if($journal->records()->whereIn('account_head_id',[1])->where('transaction_type','DR')->first())
                                                            ...
                                                            <td>
                                                                ...
                                                                @elseif($journal->jobProject)
                                                                By Project {{$journal->jobProject->project_name}}

                                                                @elseif($journal->receipt)
                                                                By Receipt {{$journal->receipt->receipt_no}} for project {{$journal->receipt->receipt_no}}
