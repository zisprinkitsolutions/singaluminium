                ...
                <div class="tab-pane active p-2">
                    <div class="content-body">
                        <div class="pl-2 print-hideen">
                            @include('clientReport.report._subhead_tax_report', ['activeMenu' => 'comprehensive_income',])
                        </div>
                            ...
                            <div class="card-body pt-0 pb-0">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody id="purch-body">
                                        ...
                                        <tr>
                                            <th class="pl-1" style="background: #0000000f !important; font-size: 11px !important; font-weight: bold">Statement of Other Comprehensive Income</th>
                                        ...
                                        <tr class="head-details" data-target="{{$comprehensive_results[0]['account_type']}}" data-type="{{$comprehensive_results[0]['type']}}">
                                            ...
                                            <td class="text-right pr-1">{{number_format($income_1 = $comprehensive_results[0]['net_amount']<0?$comprehensive_results[0]['net_amount']*-1:$comprehensive_results[0]['net_amount'],1, '.', '')}}</td>
                                        </tr>
                                        ...
                                        <tr class="head-details" data-target="{{$comprehensive_results[1]['account_type']}}" data-type="{{$comprehensive_results[1]['type']}}">
                                            ...
                                            <td class="text-right pr-1">{{number_format($loss_1 = $comprehensive_results[1]['net_amount']<0?$comprehensive_results[1]['net_amount']*-1:$comprehensive_results[1]['net_amount'],1, '.', '')}}</td>
                                        </tr>
                                        <tr class="subhead d-none"></tr>
                                        ...
                                        <tr class="head-details" data-target="{{$comprehensive_results[2]['account_type']}}" data-type="{{$comprehensive_results[2]['type']}}">
                                            ...
                                            <td class="text-right pr-1">{{number_format($income_2 = $comprehensive_results[2]['net_amount']<0?$comprehensive_results[2]['net_amount']*-1:$comprehensive_results[2]['net_amount'],1, '.', '')}}</td>
                                        </tr>
                                        <tr class="subhead d-none"></tr>
                                        <tr class="head-details" data-target="{{$comprehensive_results[3]['account_type']}}" data-type="{{$comprehensive_results[3]['type']}}">
                                            ...
                                            <td class="text-right pr-1">{{number_format($loss_2 = $comprehensive_results[3]['net_amount']<0?$comprehensive_results[3]['net_amount']*-1:$comprehensive_results[3]['net_amount'],1, '.', '')}}</td>
                                        </tr>
                                        <tr class="subhead d-none"></tr>
                                        <tr class="head-details" data-target="{{$comprehensive_results[4]['account_type']}}" data-type="{{$comprehensive_results[4]['type']}}">
                                            ...
                                            <td class="text-right pr-1">{{number_format($income_3 = $comprehensive_results[4]['net_amount']<0?$comprehensive_results[4]['net_amount']*-1:$comprehensive_results[4]['net_amount'],1, '.', '')}}</td>
                                        </tr>
                                        <tr class="subhead d-none"></tr>
                                        ...
                                        <tr class="head-details" data-target="{{$comprehensive_results[5]['account_type']}}" data-type="{{$comprehensive_results[5]['type']}}">
                                            ...
                                            <td class="text-right pr-1">{{number_format($loss_3 = $comprehensive_results[5]['net_amount']<0?$comprehensive_results[5]['net_amount']*-1:$comprehensive_results[5]['net_amount'],1, '.', '')}}</td>
                                        </tr>
                                        <tr class="subhead d-none"></tr>
                                        
                                        <tr>
                                            <td class="pl-2" style="font-size: 11px !important;"><strong>Total Comprehensive Income for The Year (AED)</strong></td>
                                            <td class="text-right pr-1" style="background: #b3b1b1b4 !important">{{number_format($net_profit,1, '.', '')}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <p class="mb-0">
