                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="config-value" class="form-control @error('config_value') error @enderror" name="config_value" value="{{ isset($edit_setting) ? $edit_setting->config_value : old('config_value')}}" placeholder="Config Value" required>
                                                        @error('config_value')
                                                        <span class="error">{{ $message }}</span>
                                                        @enderror
                                                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#section_id').change(function(){
                ...
                success:function(response){
                    ...
                    response.forEach(function(element, index) {
                        console.log(element);
                        optionHtml += "<option value='"+element.id +"'> "+ element.fname + " " +element.mname + "("+element.id+")" +"</option>";
                     });
