...
<section class="print-hideen border-bottom" style="background-color: #34465b;">
    <div class="row pl-1 pr-1">
        <div class="col-md-6"><h4 class="card-title" style="font-family:Cambria;font-size: 2rem;color:#fff;padding-top: 2px;">{{ isset($edit_setting) ? 'Update' : 'Create' }} Settings</h4></div>
        <div class="col-md-6">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row pl-1 pr-1">
                                        ...
                                        <div class="col-md-1 d-flex justify-content-end mt-2 mb-2">
                                            <button type="submit" class="btn btn-primary formButton" style="padding: 4px 6px;" title="Save" id="SearchButton">
                                                <div class="d-flex">
