...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background:#364a60;">
    <div class="row pl-2">
        <div class="col-md-6 pl-1">
            <h3 style="font-family:Cambria;font-size: 2rem;color:white;">Expense</h3>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-12 text-center">
            <div class="col-md-12">
                <div class="border-botton">
                    <div class="mx-2">
                        <form class="search_home_reports" data="home-expense">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm table-striped" style="width: 1000px"
                                data-table="payable">
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th style="width: 12%">Amount <br> {{number_format($grand_total_amount,2)}}</th>
                                        {{-- <th>Status</th> --}}
                                    </tr>
                                </thead>
                                <tbody id="purch-body">
                                    @foreach ($expenses as $item)
                                    <tr class="purch_exp_view toggle-expense-view" id="{{ $item->id }}" style="text-align:center;">
                                        <td>{{ date('d/m/Y', strtotime($item->date)) }}</td>
                                        <td>{{ $item->purchase_no }}</td>
                                        <td>{{ $item->invoice_no }}</td>
                                        <td style="text-transform:uppercase; text-align:left">{{ $item->party->pi_name }}</td>
                                    ...
                                    <tr id="expense-view-row-{{ $item->id }}" style="display: none;">
                                        <td colspan="5">
                                            <div class="expense-view-container-{{ $item->id }}">
