...
<section class="print-hideen border-bottom" style="background: #364a60;">
    <div class="d-flex flex-row-reverse" style="padding-top: 5px;padding-right: 8px;">
        ...
        <div class="" style="margin-top: 5px;padding-right: 3px;"><a href="#" onclick="window.print();" class="btn btn-icon btn-success" data-dismiss="modal"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Print"><i
                    class="bx bx-printer"></i></a></div>
        @if ($payment->status == 'Realised')
            <div class="" style="margin-top: 5px;padding-right: 3px;">
                <a href="#" disabled class="btn btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Realised">
                    <i class="fa fa-external-link" style="font-size:17px"></i>
                </a>
            </div>
        @else
