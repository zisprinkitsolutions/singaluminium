                                        ...
                                        <div class="row mx-1">
                                                    ...
                                                    <div class="col-12 customer-select">
                                                        <select name="project_id" id="project_id" class="common-select2"
                                                            ...
                                                            @foreach ($projects as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ $item->id == $lpo_bill->project_id ? 'selected' : '' }}>
                                                        ...
                                                        <select name="task_id" id="task_id" class="common-select2"
                                                            ...
                                                            @foreach (optional($lpo_bill->project)->tasks ?? [] as $task)
                                                                <option value="{{ $task->id }}"
                                                                    {{ $task->id == $lpo_bill->task_id ? 'selected' : '' }}>
                                                                    {{ $task->task_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-12 customer-select">
                                                        <select name="sub_task_id" id="sub_task_id" class="common-select2"
                                                            ...
                                                            @foreach (optional($lpo_bill->task)->items ?? [] as $itm)
                                                                <option value="{{ $task->id }}"
                                                                    {{ $itm->id == $lpo_bill->task_item_id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-2 col-left-padding">
                                                ...
                                                <input type="text" class="form-control inputFieldHeight datepicker"
                                                    ...
                                                    value="{{ $lpo_bill->delivary_date ? date('d/m/Y', strtotime($lpo_bill->delivary_date)) : '' }}">
                                            </div>
                                            ...
                                            <div class="col-md-3 col-left-padding">
                                                ...
                                                <input type="text" class="form-control inputFieldHeight"
                                                    ...
                                                    value="{{ $lpo_bill->contact_person }}">
                                            </div>

                                            <div class="col-md-3 col-left-padding">
                                                <label for=""> For </label>
                                                <input type="text" class="form-control inputFieldHeight"
                                                    name="for" placeholder="For" value="{{ $lpo_bill->lpo_for }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
