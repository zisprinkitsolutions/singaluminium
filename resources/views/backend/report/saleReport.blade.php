        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                <section id="widgets-Statistics">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>{{isset($date)? $date: (isset($from)? $from." to ".$to: date('d M Y')) }} Sales Report</h4>
                        </div>
                    ...
                    <div class="row pt-2 d-flex justify-content-end">
                        ...
                        <div class="col-md-6">
                            @if(isset($date))
                            <a href="{{ route('salePrintDate',$date) }}" class="btn btn-sm btn-info float-right"
                            target="_blank">Print</a>
                            @elseif (isset($from))
                            <a href="{{ route('salePrintRange',['from'=>$from,'to'=>$to]) }}" class="btn btn-sm btn-info float-right"
                            target="_blank">Print</a>
                            @else
                            <a href="{{ route('salePrintreport2') }}" class="btn btn-sm btn-info float-right"
                            target="_blank">Print</a>
                            @endif
                        ...
                        <div class="table-responsive pt-1">
                            <table class="table table-sm table-bordered">
                               ...
                               <tr>
                                <td><a href="{{ route('invoiceView', $inv) }}">{{ $inv->invoice_no }}</a></td>
                               <td>{{ $inv->date }}</td>
                               <td>{{ $inv->pay_mode }}</td>
