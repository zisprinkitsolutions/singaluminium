                        ...
                        <div class="card cardStyleChange">
                            ...
                            <div class="card-body">
                                <div class="table-responsive" style="min-height: 400px;">
                                    <table class="table mb-0 table-sm filter-table accordion">
                                        <thead class="thead-light print-hidden">
                                            <tr style="height: 50px;">
                                                <th class="font-size">Date</th>
                                                <th class="font-size">VEHICLE NUMBER</th>
                                        ...
                                        @foreach ($trucks as $item)
                                            ...
                                            <tr class="d-none">
                                                <td class="font-size">Date</td>
                                                <td class="font-size">{{$item->vehicle_number}}</td>
                                                <td class="font-size">Description</td>
                                                <td class="text-right font-size">Debit</td>
                                                <td class="text-right pr-1 font-size">Credit</td>
                                            </tr>
                                            ...
                                            <tr class="mb-3">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td colspan="" class="text-right font-size"><p>BALANCE C/D</p></td>
