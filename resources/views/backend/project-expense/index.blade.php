                                    ...
                                    <div class="card-body bg-white">
                                        <div class="d-flex justify-content-between align-items-center print-hidden">
                                            <form class="d-flex align-items-center" style="width: 70% !important;">
                                                ...
                                                <div style="padding-left:10px; width: 40% !important; margin-right: 5px;">
                                            ...
                                            <div class="dropdown print-hideen mb-1">
                                        ...
                                        <table class="table table-bordered table-sm" id="expense">
                                            ...
                                            <tbody id="purch-body">
                                                ...
                                                <tr>
                                                    <td class="report-details" data-url="{{route('project.expense.report.details',$item->id)}}" style="text-align: left !important;" title="{{$item->project_name}}"> {{ \Illuminate\Support\Str::limit($item->name, 25) }} </td>
                                                    <td class="report-details" data-url="{{route('project.expense.report.details',$item->id)}}" style="text-align: lfef !important;"> {{$item->address}} </td>
