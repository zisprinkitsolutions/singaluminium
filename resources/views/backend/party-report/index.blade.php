                            ...
                            <div class="card-body pt-0 pb-0">
                                <div id="party_table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right pr-1">{{number_format($total_dr,2)}}</th>
                                        <th class="text-right pr-1">{{number_format($total_cr,2)}}</th>
                                        <th class="text-right pr-1" colspan="2">{{$balance>=0? 'DR '.number_format($balance,2):'CR '.number_format(((-1)*$balance),2)}} </th>
                                    </tr>
