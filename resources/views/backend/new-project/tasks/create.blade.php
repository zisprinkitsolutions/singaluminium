                ...
                <div class="tab-content bg-white">
                    <div id="journaCreation" class="tab-pane active">
                        <section class="p-1" id="widgets-Statistics">
                            <form class="repeater mt-1 project-form" action="{{ route('project.tasks.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control inputFieldHeight" id="task" name="task_name" required autocomplete="off">
                                    ...
                                    <div style="margin-top: 18px">
                                        <a href="{{ route('project.tasks.index') }}" class="btn btn-info project-btn ml-1" style="height: 35px; width: 133px;">
                                            Tasks List
                                        </a>
                                    </div>
                                </div>
                                ...
                                <table class="auto-index repeater1 table table-sm">
                                    ...
                                    <tbody id="boq-body">
                                        <tr class="task-row" data-task-index="0">
                                            <td style="width:15%;">
                                                <div class="d-flex">
                                                    <input type="text" name="subtask_name[0]" class="form-control task-name" placeholder="SubTask">
                                                </div>
                                            </td>
                                            <td colspan="8" style="width:85%;">
                                                <table class="table table-sm mb-0" style="width:100%;">
                                                    <tbody class="item-body">
                                                        <tr>
                                                            <td style="width:width:50%"><input type="text" name="item_description[0][0]" class="form-control" placeholder="Item Description" autocomplete="off"></td>
                                                            <td style="width:10%"><input type="text" name="unit[0][0]" class="form-control text-center" placeholder="Unit" required autocomplete="off"></td>
                                                            <td style="width:10%"><input type="number" name="qty[0][0]" class="form-control qty text-right" placeholder="Qty" autocomplete="off"></td>
                                                            <td style="width:10%"><input type="text" name="rate[0][0]" class="form-control rate text-right" placeholder="Rate" autocomplete="off"></td>
                                                            <td style="width:15%"><input type="text" name="amount[0][0]" class="form-control total text-right" placeholder="Amount" required></td>
                                                            <td style="width:5%">
                                                                <div class="d-flex">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="subtotal" readonly
                                                                step="0.01" class="form-control text-right subtotal">
                                            </td>
                                        </tr>
