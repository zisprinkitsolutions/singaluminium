<div class="modal-content">
    <div class="modal-header" style="padding: 5px 18px;background:#364a60;">
        <h5 class="modal-title" id="exampleModalLabel" style="font-family:Cambria;font-size: 2rem;color:white;">Project Update</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
    <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data" class="text-left">
        @csrf
        @method('PUT');
            ...
            <div class="card-body ">
                ...
                <div class="row mx-1 pt-1">
                    ...
                    <div class="col-md-1 pl-0">
                        ...
                        <input type="text" value="{{ date('d/m/Y', strtotime($project->date)) }}" class="form-control inputFieldHeight datepicker" name="date" placeholder="dd-mm-yyyy" required>
                        @error('date')
                    ...
                    <div class="col-md-2 pl-0">
                        ...
                        <input type="text" name="project_name" id="project_name" class="form-control inputFieldHeight" value="{{$project->project_name}}" required>
                    </div>

                    <div class="col-md-2 pl-0">
                        <label for="">Project No</label>
                        <input type="text" name="project_no" id="project_no" class="form-control inputFieldHeight" value="{{$project->project_no}}" required>
                    </div>
                    <div class="col-md-2 pl-0">
                        <label for="">Address</label>
                        <input type="text" name="address" id="address" class="form-control inputFieldHeight" value="{{$project->address}}">
                    </div>
                    <div class="col-md-1 pl-0">
                        <label for="">Start Date</label>
                        <input type="text" name="start_date" id="start_date" class="form-control inputFieldHeight datepicker" value="{{$project->start_date?date('d/m/Y', strtotime($project->start_date)):null}}">
                    </div>
                    <div class="col-md-1 pl-0 pr-0">
                        <label for="">End Date</label>
                        <input type="text" name="end_date" id="end_date" class="form-control inputFieldHeight datepicker" value="{{$project->end_date?date('d/m/Y', strtotime($project->end_date)):null}}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="cardStyleChange" style="width: 100%">
                    <div class="card-body bg-white">
                        <table class="table  table-sm ">
                            ...
                            <tbody id="TBody">
                                @foreach ($project->tasks as $key => $item)
                                    <tr class="text-center invoice_row">
                                        <td>
                                            <div class="d-flex justy-content-between align-items-center" >
                                                <input type="text" name="group-a[{{$key}}][description]" value="{{$item->task_name}}"  placeholder="Item Description" class="form-control inputFieldHeight description" required>
                                            </div>
                                        </td>
                                ...
                                <tr id="TRow" class="text-center invoice_row d-none">
                                    <td>
                                        <div class="d-flex justy-content-between align-items-center" >
                                            <input type="text" name="group-a[{{count($project->tasks)+1}}][description]" disabled  placeholder="Item Description" class="form-control inputFieldHeight description" required>
                                        </div>
                                    </td>

                                    <td>
                                        <input type="number" step="any" name="group-a[{{count($project->tasks)+1}}][qty]" step="any" placeholder="QTY" class="text-center form-control inputFieldHeight qty"style="width: 100%;" disabled required>
                                    </td>
                                    <td>
                                        <input type="number" step="any" name="group-a[{{count($project->tasks)+1}}][sqm]" step="any" placeholder="SQM" class="text-center form-control inputFieldHeight sqm"style="width: 100%;" disabled required>
                                    </td>
                                    <td>
                                        <input type="number" step="any" name="group-a[{{count($project->tasks)+1}}][amount]" step="any" required placeholder="Rate" disabled class="text-center form-control inputFieldHeight amount"style="width: 100%;">
                                    </td>

                                    <td>
                                        <input type="number" step="any" name="group-a[{{count($project->tasks)+1}}][sub_gross_amount]" required disabled class="text-center form-control sub_gross_amount inputFieldHeight" placeholder="Total Amount" style="width: 100%;" readonly>
                                    </td>
                                    <td class="NoPrint add_button text-center d-flex" style="margin-top: 5px;">
                                        <button type="button" class="bg-danger custom-btn" onclick="BtnDelItem(this)">
                                            <i class="bx bx-trash"></i>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" step="any" readonly
                                            ...
                                            name="taxable_amount" value="{{$project->budget}}"
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><input type="number" step="any" readonly
                                            ...
                                            name="total_vat" value="{{$project->vat}}"
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" step="any" readonly
                                            ...
                                            name="total_amount" value="{{$project->total_budget}}"
