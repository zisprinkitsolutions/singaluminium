            ...
            <tbody>
                ...
                <tr class="text-center text-uppercase">
                    ...
                    <td class="view-project text-left" data-id="{{ $project->id }}"
                        ...
                        title="{{ $project->company->company_name??'SINGH ALUMINIUM AND STEEL' }}">
                        {{ \Illuminate\Support\Str::limit(@$project->company->company_name, 15) ?? \Illuminate\Support\Str::limit('SINGH ALUMINIUM AND STEEL', 15)}} </td>
