                ...
                <div id="journaCreation" class="tab-pane active">
                    <section class="p-1" id="widgets-Statistics">
                        <div class="d-flex justify-content-between align-items-center">
                            <form class="col-md-10 d-flex align-items-center mr-1"></form>
                            <div class="col-md-2 d-flex text-right">
                                <button class="btn btn-info inputFieldHeight" style="padding:3px 8px !important; margin-right:5%;" data-toggle="modal" data-target="#partyInfo"> Project Ledger </button>
                            </div>
                        </div>
                                    ...
                                    @foreach ($projects as $project)
                                        ...
                                        <table class="table table-sm" style="border: 1px solid">
                                            ...
                                            @foreach ($project->invoices as $invoice)
                                                @php
                                                    $journal=App\Journal::where('invoice_id', $invoice->id)->first();
                                                    $isPayment=true;
                                                @endphp
                            ...
                            <form action="{{ route('search-project-report') }}" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-1 d-flex justify-content-end changeColStyle">
                                        <button type="button" class="btn mb-2 btn-success formButton inputFieldHeight mr-1" style="padding: 5px 10px !important;" title="All Project" width="25" data-url="{{ route('search-project-report') }}">
                                            All Project
                                        </button>
