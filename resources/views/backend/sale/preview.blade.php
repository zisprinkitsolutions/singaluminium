...
<section class=" border-bottom" style="padding: 5px 30px;background:#364a60;">
    <div class="d-flex flex-row-reverse align-items-center">
        <div class="" style=""><a href="#" class="close btn-icon btn btn-danger"
                data-dismiss="modal" aria-label="Close" style="" title="Close"><span
                    aria-hidden="true"><i class='bx bx-x'></i></span></a></div>
        @if ($sale->invoice_type == 'Proforma Invoice')
            <div class="" style="padding-right: 3px;"><a
        ...
        <div class="w-100">
            <h4 style="font-family:Cambria;font-size: 1.4rem;color:white;">
                {{ $sale->trn=='YES'?'Tax Invoice':'Invoice' . ' ('.$sale->invoice_no .')' }}
...
<section id="widgets-Statistics" class="pt-2 px-1">
            ...
            <table class="table table-sm table-bordered border-botton proview-table" style="color: black; ">
                ...
                <tbody class="user-table-body">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            {{ number_format(($sale->retention_amount > 0 ? $sale->retention_amount : 0),2)}}
                        </td>
                    </tr>
    ...
    <div class="d-flex justify-content-center align-items-center pb-1" >
        <div class="" >
            ...
            <div class="" style="">
                <button type="button" class="btn btn-primary custom-action-btn" data-toggle="modal" data-target="#receiptModal" >Receive Payment </button>
            </div>
            @endif
        </div>
        <div class="" >
            <a href="{{route('invoice-delete',$sale)}}" class="btn btn-icon btn-danger custom-action-btn" title="Delete"
                onclick="event.preventDefault(); deleteAlert(this, 'About to delete invoice. Please, confirm?');">
                <i class="bx bx-trash"></i> Delete
            </a>
        </div>
        <div class="" style=";">
            <a href="{{ route('sale-print', $sale->id) }}" target="_blank" class="btn btn-icon btn-secondary custom-action-btn" title="Print Now">
