...
<form action="{{ route('saleIssuepost') }}" method="POST" id="formSubmit"
                            ...
                            <div class="cardStyleChange" style="width: 100%">
                                <div class="card-body bg-white">
                                    <table class="table table-bordered table-sm ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black"> TAXABLE AMOUNT <br> <span class="d-none"><small><small> <input type="number" step="any" name="" value="0.00"  style="border: none;background: transparent;    text-align: right;" class="taxable-amount" readonly id="">Remaining</small></small></span></td>
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black"> TOTAL VAT <br> <span class="d-none"><small><small> <input type="number" step="any" name="" value="0.00"  style="border: none;background: transparent;    text-align: right;" class="remaining-vat" readonly id="">Remaining</small></small></span></td>
                                             ...
                                             <tr>
                                                <td colspan="4" class="text-right" style="color: black"> RETENTION</td>
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black">TOTAL AMOUNT <br><span class="d-none"><small><small> <input type="number" step="any" name="" value="0.00"  style="border: none;background: transparent;    text-align: right;" class="total-remaining" readonly id="">Remaining</small></small></span></td>
                    ...
                    <div class="cardStyleChange">
                        <div class="card-body bg-white">
                            ...
                            <div id="preview-images" class="ml-1 d-flex flex-wrap"></div>
                            <div class="d-flex justify-content-center align-items-center">
                                <button type="submit" class="btn btn-primary formButton inputFieldHeight"
                                    style="padding:5px 10px !important;" id="submitButton">
                                    <div class="d-flex">
