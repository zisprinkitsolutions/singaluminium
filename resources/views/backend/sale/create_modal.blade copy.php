                        ...
                        <div class="card-body">
                            ...
                            <div class="row mx-1 pt-1">
                                ...
                                <div style="width:27%;margin-left:5px;">
                                    ...
                                    <select name="job_project_id" id="job_project_id" class="form-control common-select2 job_project_id">
                                        <option value=""> Select... </option>
                                    </select>
                                    ...
                                    <table class="table table-bordered table-sm ">
                                        ...
                                        <tbody>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <td >
                                                    <input type="number" step="any"
                                                        name="rentention_amount" required
                                                        class="text-center form-control rentention_amount"
                                                        style="width: 100%;height:36px;" readonly>
                                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black">PAYABLE AMOUNT</td>
