...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background:#364a60;">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="" style="margin-top: 5px;padding-right: 3px;"><a href="#" onclick="window.print();"
                class="btn btn-icon btn-success"><i class="bx bx-printer" data-bs-toggle="tooltip"
                    data-bs-placement="bottom" title="Print"></i></a></div>
        ...
        @else
            <div class="" style="padding: 5px 3px;"><a href="{{ route('receipt-realised', $recept) }}"
                    class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="bottom"
                    title="Realised"><i class="fa fa-external-link" style="font-size:17px"></i></a></div>
            <div class="" style="white-space: nowrap;padding: 5px 0px;"><a href="#"
                    class="btn btn-sm btn-icon btn-info " data-toggle="modal" data-target="#notSubmit"
            ...
            <div class="" style="padding: 5px 3px;"><a href="{{ route('receipt-declined', $recept) }}"
                    class="btn btn-sm btn-icon {{ $recept->status == 'Declined' ? 'btn-warning' : 'btn-danger' }}"
        ...
        <div class="" style="padding-right: 3px;margin-top: 6px;">
            <a href="{{ route('receipt-delete', $recept) }}" class="btn btn-icon btn-danger" title="Delete"
                onclick="event.preventDefault(); deleteAlert(this, 'About to delete receipt voucher. Please, confirm?');">
                <i class="bx bx-trash"></i>
            </a>
        </div>

        <div class="" style="padding-right: 3px;margin-top: 6px;width:185px">
            <a href="#" class="btn btn-icon btn-danger change-payment" style="padding: 0.2rem 0.6rem !important" onclick="togglePayment()"
