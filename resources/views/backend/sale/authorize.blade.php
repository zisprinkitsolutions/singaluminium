                                            ...
                                            <table class="table table-bordered table-sm " style="width: 850px">
                                                <thead class="thead">
                                                    ...
                                                    <tr class="sale_view"  id="{{$item->id}}">
                                                        ...
                                                        <span class="text-danger">{{ $item->proforma_invoice_no }}</span> <br>
                                                        @elseif($itme->invoice_type == 'Direct Invoice')
                                                        <span class="text-danger">{{ $itme->invoice_no_s_d }}</span> <br>

                                                        @else
                                                        <span class="text-danger">{{ $itme->invoice_no }}</span> <br>
                                                        @endif
