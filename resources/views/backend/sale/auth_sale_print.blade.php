                   ...
                   <tr>
                    <td>
                        ...
                        <div class="row" style="padding: 0px 9px;">
                            <div class="col-sm-12">
                                <h4 class=" text-center" style="margin:0;padding:0;line-height:40px;color: #1d1d1d !important;">
                                    <strong>{{$sale->invoice_type=="Tax Invoice"? 'TAX INVOICE':($sale->invoice_type=="Proforma
                                        Invoice"?'PROFORMA INVOICE':'INVOICE')}}</strong> </h4>
                                <p class="text-center mb-2" style="color: #1d1d1d !important;">
                                    ...
                                    {{-- ,@if ($sale->invoice_type == 'Tax Invoice') VAT TRN No: {{'('.$trn_no.')'}},@endif Running
                                    No:{{$running_no}} --}}
                                </p>
                                    ...
                                    <table class="table table-sm table-bordered" style="color: #1d1d1d !important;">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {{optional($new_project)->name}}, {{$sale->project->project_name??''}}
                                            </td>
                                ...
                                <table class="table-sm table-bordered border-botton  w-100" style="color: black; ">
                                    <thead style="background-color: #706f6f33 !important;color: black;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="text-transform: uppercase; color: black !important;width:70px"> UNIT
                                                PRICE <small>(@if(!empty($currency->symbole)){{$currency->symbole}}@endif)</small></th>
                                            <th class="text-center" style="text-transform: uppercase; color: black !important;width:130px"> NET
                                                AMOUNT <small>(@if(!empty($currency->symbole)){{$currency->symbole}}@endif)</small></th>
                                            <th class="text-center" style="text-transform: uppercase; color: black !important;width:80px"> TAX
                                                RATE </th>
                                            <th class="text-center" style="text-transform: uppercase; color: black !important;width:80px"> TAX
