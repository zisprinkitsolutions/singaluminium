                            ...
                            <div class="cardStyleChange" style="width: 100%">
                                <div class="card-body bg-white">
                                    <table class="table table-bordered table-sm ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black"> TAXABLE AMOUNT <br><small><small> <input type="number" step="any" name="" value="0.00"  style="border: none;background: transparent;    text-align: right;" class="taxable-amount" readonly id="">Remaining</small></small></td>
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black"> TOTAL VAT <br><small><small> <input type="number" step="any" name="" value="0.00"  style="border: none;background: transparent;    text-align: right;" class="remaining-vat" readonly id="">Remaining</small></small></td>
                                            ...
                                            <tr>
                                                <td colspan="4" class="text-right" style="color: black">TOTAL AMOUNT <br><small><small> <input type="number" step="any" name="" value="0.00"  style="border: none;background: transparent;    text-align: right;" class="total-remaining" readonly id="">Remaining</small></small></td>
