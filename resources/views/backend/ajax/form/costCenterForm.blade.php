                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-end ">
                            <button class="btn btn-info profit-center-form-btn"
                            data_target="{{ route('profitCenterForm') }}" disabled style="margin-right: 0.2rem !important;">New</button>
                            <button type="submit" class="btn btn-primary" style="margin-right: 0.2rem !important;">Submit</button>
