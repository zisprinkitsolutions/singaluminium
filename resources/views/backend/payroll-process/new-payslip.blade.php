<section class="print-hideen border-bottom">
    <div class="d-flex flex-row-reverse">
        ...
        <div class="mIconStyleChange"><a href="#"  class="btn btn-icon btn-secondary printPayrollProcesseModal" data-dismiss="modal" id="{{$payroll_process_info->id}}"><i class='bx bx-printer'></i></a></div>
