...
<section class="print-hideen border-bottom" style="background: #364a60;">
    <div class="d-flex flex-row-reverse" style="padding-top: 5px;padding-right: 8px;">
        ...
        <div class="" style="margin-top: 5px;padding-right: 3px;">
            <a href="{{ route('temp-payment-voucher-delete', $payment->id) }}" class="btn btn-sm btn-icon btn-danger"  onclick="event.preventDefault(); deleteAlert(this, 'About to delete invoice. Please, confirm?');"><i class="bx bx-trash"></i></a>
        </div>
        <div class="pr-1" style="margin-top: 5px;margin-right: -12px;"><a href="#" onclick="window.print();" class="btn btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Print"><i class="bx bx-printer" style="padding-bottom: 2px;"></i></a></div>
        ...
        @else
            <div class="" style="margin-top: 5px;padding-right: 3px;">
                <a href="{{ route('payment-voucher-approve', $payment) }}" class="btn btn-sm btn-icon btn-warning"  onclick="event.preventDefault(); deleteAlert(this, 'About to approve. Please, confirm?', 'approve');" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Approve"><i class="bx bx-check"></i></a>
            </div>
        @endif
        <div class="" style="margin-top: 5px;padding-right: 3px;">
            <a href="#" class="btn btn-sm btn-icon btn-primary payment-edit" id="{{$payment->id}}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bx bx-edit"></i></a>
        </div>
...
<section id="widgets-Statistics">
    <div class="payment-voucher px-2 pt-1 pb-4" style=" border: 1px solid; margin: 20px; border-radius: 20px;">
        ...
        <div class="d-flex justify-content-between aligin-items-center mb-1">
            <span style="width:160px !important; color:#313131;font-size:15px;font-weight:bold; line-height:23px !important;">
                Paid to Mr./Ms.</span>
            ...
            <span style="width:215px !important; color:#313131;font-size:15px;font-weight:bold; line-height:23px !important;">
        ...
        <div class="d-flex w-100">
            <div class="d-flex justify-content-between aligin-items-center mb-1 w-100">
                <span style="width:155px !important; color:#313131;font-size:15px;font-weight:bold; line-height:23px !important;">
                    The Sum of Dhs:
                </span>
                <div class="w-100" style="border-bottom:1px dashed #111;">
                ...
                <span style="width:95px !important; color:#313131;font-size:15px;font-weight:bold; line-height:23px !important;">
                    المبلغ درهم
                </span>
            </div>
        </div>
        ...
        <div class="d-flex w-100">
            <div class="d-flex justify-content-between aligin-items-center mb-1 w-100">
                <span style="width:305px !important; color:#313131;font-size:15px;font-weight:bold; line-height:23px !important;">
                    By Cash / Cheque:
                </span>
                <div class="w-100" style="border-bottom:1px dashed #111;">
                    <p style="margin:0 !important;padding:0!important;color:#313131;font-size:15px;font-weight:500 !important; padding-left:30px">
                ...
                <span style="width:190px !important; color:#313131;font-size:15px;font-weight:bold; line-height:23px !important;">
                    نقدا / رقم الشيك
                </span>
            </div>
            <div class="d-flex justify-content-between aligin-items-center mb-1 w-100">
...
<div class="img receipt-bg">
    <img src="{{ asset('img/singh-bg.png') }}" class="img-fluid" style="position: fixed; top: 450px; left: 220px; opacity: 0.3; width: 600px !important; height: 200px;" alt="">
