...
<section class="print-hideen border-bottom" style="padding: 5px 15px;background: #34465b;">
    <div class="d-flex flex-row-reverse" style="padding: 0 11px;">
        ...
        {{-- <div class="mIconStyleChange" style="padding: 10px 2px !important;"><a href="#"  onclick="window.print();" class="btn btn-icon btn-success" title="Print"><i class='bx bx-printer'></i></a></div>
...
<section id="widgets-Statistics" style="padding: 0 15px;">
    ...
    <div class="cardStyleChange">
        <div class="card-body">
                ...
                <table class="table table-sm table-bordered border-botton">
                    ...
                    <tbody class="user-table-body">
                            ...
                            <tr class="text-center trFontSize">
                                ...
                                <td  class="text-right pr-1">{{ $retVal = ($record->transaction_type=='DR') ? $currency->symbole .' '.number_format($record->amount,) : ''  }}</td>
                                <td  class="text-right pr-1">{{ $retVal = ($record->transaction_type=='CR') ? $currency->symbole .' '.number_format($record->amount,) : ''  }}</td>
                            </tr>
                            @endforeach
            ...
            <div class="col-12 d-flex justify-content-center print-hideen my-1">
                ...
                <div class="print-hideen">
                    <a href="{{ route('journalMakeApprove',$journal) }}" onclick="return confirm('about to authorize journal. Please, Confirm?')" class="btn btn-info custom-action-btn">
                        <img src="{{asset('assets/backend/app-assets/icon/save-icon.png')}}" alt="" srcset="" width="20" style="margin-right: 5px;">
                        Approve
                    </a>
                </div>
