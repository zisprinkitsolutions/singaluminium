                            ...
                            <table class="table table-sm table-bordered table-hover">
                                <thead class=" thead">
                                    <tr class="mTheadTr">
                                        ...
                                        <th class="text-left pl-1">Created By</th>
                                ...
                                <tbody class="user-table-body ">
                                    @foreach ($journals as $journal)
                                        <tr class="text-center trFontSize">
                                            ...
                                            <td style="min-width:150px" class="text-left pl-1">{{$journal->createdBy? $journal->createdBy->name:''}}</td>
                                            <td class="text-right pr-1">@if(!empty($currency->symbole)){{$currency->symbole}}@endif{{ number_format($journal->amount,2) }}</td>
                                            <td>
                                                <div class="d-flex justify-content-evenly pb-1">
                                                    <a href="{{ route('journal_edit', $journal->id)}}" class="btn" style="height: 25px; width: 25px;">
                                                        <img src="{{ asset('assets/backend/app-assets/icon/edit-icon.png')}}" title="Edit" style=" height: 25px; width: 25px;">
                                                    </a>
