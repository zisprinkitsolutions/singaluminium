    ...
    <div class="app-content content print-hideen">
        ...
        <div class="content-wrapper">
            <div class="content-body">
                 @include('clientReport.setup._header',['activeMenu' => 'work-type'])
                                ...
                                <div class="col-md-8 text-left">
                                    ...
                                    <a class="btn btn-xs btn-primary  formButton" title="Create BOQ Sample" data-toggle="modal" data-target="#house-type">
                                        <div class="d-flex">
                                            ...
                                            <div><span> Create Work Type </span></div>
                                        </div>
                                    </a>
                                    @endif
                                </div>
                                ...
                                <table class="table mb-0 table-sm table-hover">
                                    <thead  class="thead-light">
                                        <tr style="height: 40px;">
                                            <th style="width:15%;" class="text-left"> Work Type </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($work_types as $key => $type)
