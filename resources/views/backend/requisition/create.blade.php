                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="row px-1">
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <input type="text" id="plot_no"
                                                    class="form-control inputFieldHeight" placeholder="Enter plot no">
                                            </div>
                                            ...
                                            <div class="col-md-1 col-left-padding">
                                                ...
                                                <input type="text" value="{{ Carbon\Carbon::now()->format('d/m/Y') }}"
                                                    class="form-control inputFieldHeight datepicker" name="date" autocomplete="off"
