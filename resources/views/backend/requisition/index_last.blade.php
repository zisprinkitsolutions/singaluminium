...
<div class="app-content content print-hideen">
                                            ...
                                            <div class="data-table table-responsive">
                                                <table class="table table-sm table-hover table-striped align-middle">
                                                    <thead class="thead-light sticky-top" style=" z-index: 999;">
                                                        <tr>
                                                            <th class="number-group">#</th>
                                                            <th class="number-group">Date</th>
                                                            <th class="number-group">Req No</th>
                                                            <th class="text-group">Project</th>
                                                            <th class="status-group">Status</th>
                                                            <th class="action-group">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="purch-body">
                                                        ...
                                                        <tr style="cursor: pointer;" class="lpo_bill_view"
                                                            ...
                                                            <td class="number-group">{{ ($expenses->currentPage() - 1) * $expenses->perPage()
                                                                + $key + 1 }}</td>
                                                            <td class="number-group">{{ date('d/m/Y', strtotime($item->date)) }}</td>
                                                            <td class="number-group">{{ $item->requisition_no }}</td>
                                                            <td class="text-group">{{ $item->project->project_name
                                                                ?? '-' }}</td>
                    ...
                    <div class="modal-body">
                        <div class="row g-3 text-left">
                            ...
                            <div class="col-md-4 text-left">
                                ...
                                <select class="form-control common-select2" name="project_id" id="project_id" required>
                                    ...
                                    <option value="{{ $item->id }}"
                                        data-plot="{{ optional($item->new_project)->plot }}">
                            ...
                            <div class="col-md-3 text-left">
                                ...
                                <select class="form-control common-select2" name="attention" id="attention" required>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('requisition-rejected') }}" method="POST" id="modalForm">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="requisition_type" name="type">
                    </div>
    ...
    <script>
        ...
        $(document).on("click", ".req-reject-btn", function(e) {
            ...
            var requisition_type = $(this).data('type');
