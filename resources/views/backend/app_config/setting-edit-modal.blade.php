...
<section class="print-hideen border-bottom" style="background-color: #34465b;">
    <div class="row pl-1 pr-1">
        <div class="col-md-6"><h4 class="card-title" style="font-family:Cambria;font-size: 2rem;color:#fff;padding-top: 2px;">{{ isset($edit_setting) ? 'Update' : 'Create' }} Config Settings</h4></div>
        <div class="col-md-6">
...
<section id="basic-vertical-layouts">
    <div class="cardStyleChange">
        ...
        <div class="content-body">
            <form class="form form-vertical" action="{{ isset($edit_setting) ? route('app-configs.update', $edit_setting->id) : route('app-configs.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @isset($edit_setting)
                    @method('PUT')
                @endisset
