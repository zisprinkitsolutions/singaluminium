...
<div class="d-flex align-items-center gap-2">
    ...
    <a href="{{route("grades.index")}}" class="btn btn-outline-secondary nav-item nav-link {{ $activeMenu == 'grades' ? 'bg-secondary text-white' :'text-dark' }}" role="tab" aria-controls="nav-contact" aria-selected="false">
        <div> Grades </div>
    </a>
</div>
