...
<head>
    ...
    <style>
        ...
        body {
            background-image: url({{ asset('img/login-bg.jpeg') }});
        }
        ...
        /* শুধু ইমেজের কলামের padding বাদ দিন */
        .col-md-7.col-12.order-2.order-md-1 {
            padding-left: 0 !important;
            padding-bottom: 0 !important;
        }

        /* image কে border এর সাথে পুরোপুরি লাগানো */
        .left-section img {
            display: block;
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container mt-5">
        <div class="card " style="background-color: #f6fdff;">
            <div class="card-body ">
                <!-- Header Section -->
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-12 text-center text-md-left">
                            <div class="header-section pl-4">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-7 col-12 order-2 order-md-1">
                            <div class="left-section">
                                <img src="{{ asset('img/login-logo.png') }}" class="w-100 img-fluid" alt="">
                            </div>
                        </div>
