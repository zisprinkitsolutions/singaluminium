                        ...
                        <div class="card bg-authentication mb-0">
                            <div class="row m-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label-top" for="passwordField">PASSWORD</label>
                                                    <div class="password-container">
                                                      <input type="password" name="password" id="passwordField" placeholder="Password" class="form-control-custom @error('password') is-invalid @enderror">
                                                      <i class='bx bx-hide toggle-icon' id="togglePasswordIcon" onclick="togglePassword()"></i>
                                                    </div>
                                                    @error('password')
                                                      <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                    <img class="img-fluid" src="{{ asset('img/zikash-logo.png')}}" alt="branding logo">
                                </div>
                            </div>
                        </div>
                    </div>
